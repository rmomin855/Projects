...
General tab:
Implementations of Assignment 1,
...
- Add plane under central object
- implement Phong Shading, Blinn Shading, Phong Lighting lightings
- implement textures to use in phong model
- cylindrical, spherical, cube UV mapping types
- Calculate UV on cpu (both position and normal)
- Calculate UV on gpu (both position and normal)
- toggle mapping type
- toggle mappin entities
- toggle between CPU generated uv and GPU calculated uv
- implement 3 scenarios
- multiple lights
- able to control number of active lights
- pass light data using uniform block
- able to change all light properties for each light specifically
...
6) Number of hours spent on this Assignment : OVER 9000 (not really its 50 hours :P)