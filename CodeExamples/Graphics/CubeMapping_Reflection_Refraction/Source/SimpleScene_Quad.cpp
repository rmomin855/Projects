...
glm::vec3 Spheredistance = { 1.0f , 0.0, 0.0f };
...
phongShading(0), phongLighting(0), blinnShading(0)
{
  ...
  MeshManager::Instance()->AddMesh("cube", true);
  ...
  centralObject->transform.scale = glm::vec3(0.4f, 0.4f, 0.4f);
  ...
  ring->transform.scale = vec3(distFromCenter);
  ...
  textures[TOP] = "top.png";
  textures[DOWN] = "bottom.png";
  textures[RIGHT] = "right.png";
  textures[LEFT] = "left.png";
  textures[FRONT] = "front.png";
  textures[BACK] = "back.png";
  box = new Skybox(textures);
  box->transform.position = cameraPos;
  ...
  glTextureParameteri(diffuseTexture, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
  glTextureParameteri(diffuseTexture, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
  ...
  glTextureParameteri(specularTexture, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
  glTextureParameteri(specularTexture, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
